...
- An awareness of the need of separate scripts for initial full load and subsequent incremental load executions. 
- Understanding of the requirements from a source system e.g. last_successful_load, last_load_date columns etc. 

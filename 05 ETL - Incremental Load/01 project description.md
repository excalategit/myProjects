...
The project covers the initial work of designing a data model and loading data to it (as usual) but additionally 
...
- Understanding of the requirements from a source system e.g. modified_date, last_successful_load, last_load_date 
columns etc. 
